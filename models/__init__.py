...
from .var import VAR
from .wavelet_vqvae import VQVAE


def build_vae_var(
    # Shared args
    device, patch_nums= (1, 2, 3, 11),      #(1, 2, 3, 4, 5, 6, 8, 10, 13, 16),   # 10 steps by default
    # VQVAE args
    V=4096, Cvae=64, ch=128, share_quant_resi=4,
    # VAR args
    num_classes=None, depth=16, shared_aln=False, attn_l2_norm=True,
