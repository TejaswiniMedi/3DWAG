...
class NLayerDiscriminator(nn.Module):
    ...
    def forward(self, input0, input1=None):
        ...
        if input1 is not None:
            ...
            return self.main(input0), self.main(input1)
        else:
            return self.main(input0), None

# Example usage
#discriminator = NLayerDiscriminator(input_nc=1, ndf=64, n_layers=3, use_actnorm=True)
#input0 = torch.randn(1, 1, 64, 64, 64)
#input1 = torch.randn(1, 1, 64, 64, 64)
#output0, output1 = discriminator(input0, input1)
