...
class Args(Tap):
    data_path: str = '/home/ubuntu/Teja/VAR/imagenet100/'
    exp_name: str = 'text'
    ...
    # data
    pn: str =  '1_2_3_11'     #'1_2_3_4_5_6_8'   #_5_6_8_10_13_16'
    patch_size: int = 11  #16
    ...
    def dump_log(self):
        ...
        if '1/' in self.cur_ep: # first time to dump log
            with open(self.log_txt_path, 'w') as fp:
                json.dump({'is_master': dist.is_master(), 'name': self.exp_name, 'cmd': self.cmd, 'tb_log_dir_path': self.tb_log_dir_path}, fp, indent=0)   #commit': self.commit_id, 'branch': self.branch, 
                fp.write('\n')
...
def init_dist_and_get_args():
    # Assuming 'dist' is an instance of your distributed module setup
    ...
    args.workers = 8 #min(max(0, args.workers), args.batch_size)
